...
export default function AnimatedSection() {
  ...
  // Words with explicit line breaks
  const words = [
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4 py-4">
        {/* <h2 className="max-w-[90vw] w-full text-3xl sm:text-4xl md:text-5xl font-bold text-gray-200 leading-relaxed text-center flex flex-wrap justify-center"> */}
        <h2 className="max-w-[90vw] w-full text-3xl sm:text-4xl md:text-5xl font-bold text-gray-200 leading-relaxed text-center whitespace-pre-line">
